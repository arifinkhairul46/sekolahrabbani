        ...
        <table class="table table-bordered">
            ...
            <tbody style="font-size: 13px">
                ...
                <tr>
                    ...
                    <td id="diskon" colspan="1"><span style="font-size: 13px">Rp {{number_format(20/100 * $total_harga)}}</span></td>
                </tr>
                <tr>
                    <td colspan="5" class="text-center"><span style="font-size: 13px"><b>Total Harga</b></span></td>
                    <td colspan="1"><span style="font-size: 13px"><b>Rp {{number_format(80/100 * $total_harga)}} </b> </span></td>
                </tr>
            </tbody>
        </table>
    </div>
